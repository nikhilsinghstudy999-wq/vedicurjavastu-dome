        ...
        <section className="py-20 bg-vastu-stone/10">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              ...
              <PricingCard plan="Luxury" price="9,999" color="#E8B960" features={["All Gold features", "1 personal site visit", "Complete Vastu audit", "4 scheduled follow‑ups", "Full ritual execution if needed"]} />
            </div>
