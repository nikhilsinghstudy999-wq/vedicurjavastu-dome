      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          ...
          <p className="text-nidra-indigo/60 max-w-2xl mx-auto text-sm sm:text-base">
            AstroVastu Expert KK Nagaich uniquely combines Tantra mastery, MBA‑grade business acumen, and 4th‑generation Vedic lineage – a trio unmatched by any other commercial Vastu consultant.
          </p>
        </motion.div>
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#1a3a5c] to-[#0a1628]">
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
              AstroVastu Expert KK Nagaich – <strong className="text-prakash-gold">100M+ views, 80K+ followers, MBA, Ex‑CEO, 4th‑generation Tantra‑trained Vastu Guru</strong> – personally audits every commercial space. No delegation. No generic reports.
            </p>
