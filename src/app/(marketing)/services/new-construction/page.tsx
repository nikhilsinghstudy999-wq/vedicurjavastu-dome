        ...
        <section id="practices" className="py-16 sm:py-24 bg-white relative">
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div className="space-y-16">
              {[
                {num:'01',title:'Bhoomi Puja (Site Purification & Foundation Stone)',desc:'Cleaning with Gangajal. 64‑part Vastu Purusha drawing in NE corner. Silver idol of snake god (Sheshnaag) worshipped. Ganesh Puja, Kalash Sthapana, Sankalpa, Shatkarma, Pran Pratishtha, Havan. Auspicious months: Baisakh, Shravan, Margshirsh, Falgun.',features:['64‑part Vastu Purusha drawing','Gangajal site purification','Naga deity silver idol','Kalash Sthapana','Havan with ghee & herbs'],color:'#10B981'},
                ...
                {num:'06',title:'Vastu Planning & Blueprint Audit',desc:'64‑grid Mandala overlay on architectural blueprint. 16‑zone + 32‑entrance directional analysis. Brahmasthan kept open. SW heavier, NE lighter and open. Floor slope verification: SW highest → NE lowest. Room‑by‑room directional compliance audit.',features:['64‑grid Mandala overlay','16‑zone + 32‑entrance analysis','Brahmasthan kept open','SW→NE slope verification','Room‑by‑room compliance'],color:'#6366F1'},
        ...
        <section className="py-16 sm:py-24 bg-vastu-stone/10 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                {phase:'Phase 1: Pre‑Construction',tasks:'Bhoomi Puja (NE corner). Sutra‑pada (64‑grid marking). Shilanyas (foundation stone SW). Garbh Vinyas (foundation deposit). Ratna Sthapna. Dhatu Adhyay.',color:'#10B981'},
                ...
                {phase:'Key Dimensions',tasks:'Room corners: 90°. Foundation 4½ inches per brick. Door height = 2× width. 64‑grid domestic, 81‑grid temples.',color:'#6366F1'},
