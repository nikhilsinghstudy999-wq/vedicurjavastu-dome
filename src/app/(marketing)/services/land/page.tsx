        ...
        <section className="py-20 bg-vastu-stone/10">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <PricingCard plan="Silver" price="4,999" color="#A0A0A0" features={["No physical visit", "Layout & land analysis", "Remedies via upto 30‑min call", "One‑time delivery"]} />
              <PricingCard plan="Gold" price="6,999" color="#FFD700" features={["All Silver features", "2 follow‑up calls", "Virtual meeting", "Extended land audit"]} best />
