        ...
        <section className="py-20 bg-vastu-stone/10">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <PricingCard plan="Silver" price="9,999" color="#A0A0A0" features={["No physical visit", "Layout audit & suggestions", "Remedies via upto 30‑min call"]} />
              <PricingCard plan="Gold" price="14,999" color="#FFD700" features={["All Silver features", "2 follow‑up calls", "Virtual meeting", "Safety audit report"]} best />
