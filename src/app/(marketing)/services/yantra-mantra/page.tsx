  ...
  return (
    <>
      ...
      <SmoothScroll>
        ...
        {/* HERO */}
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#100000] via-[#300000] to-[#100000]">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center mt-16">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-white mb-6 leading-tight drop-shadow-2xl">
              <span className="bg-gradient-to-r from-red-400 via-prakash-gold to-sacred-saffron bg-clip-text text-transparent">Yantra & Mantra Therapy</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-3xl mx-auto mb-4 px-4 leading-relaxed">
              Sri Yantra Installation · Vastu Purush Yantra Placement · Mantra Chanting Prescription · Daily Recitation Protocol · Non‑Structural Vedic Correction
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/bookings" className="px-10 py-5 bg-gradient-to-r from-prakash-gold via-sacred-saffron to-red-400 text-white font-bold rounded-full shadow-[0_10px_30px_rgba(232,185,96,0.4)] hover:shadow-[0_20px_45px_rgba(255,153,51,0.5)] transition-all text-lg">
                Book Consultation
              </Link>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
            <img 
              src="/images/services/yantra-mantra/hero-placeholder.svg" 
              alt="Yantra & Mantra Therapy" 
        ...
        <section className="py-16 sm:py-24 bg-vastu-stone/10">
          <div className="container mx-auto px-4 sm:px-6 max-w-4xl text-center">
            <h2 className="font-serif text-3xl sm:text-4xl text-nidra-indigo mb-6">
              Detailed Yantra & Mantra Therapy Information Being Prepared
            </h2>
            <p className="text-nidra-indigo/60 max-w-2xl mx-auto mb-8 leading-relaxed">
              Our team is crafting a comprehensive, web‑researched guide covering every practice, puja, and remedy for Yantra & Mantra Therapy. 
            ...
            <Link href="/bookings" className="luxury-button">
              Schedule Your Yantra & Mantra Therapy Audit →
            </Link>
          </div>
        </section>

        {/* FINAL CTA */}
        <section className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-br from-[#100000] via-[#300000] to-[#100000] bg-[length:400%_400%] animate-[gradientLoop_12s_ease_infinite]">
              ...
              <div className="relative rounded-[40px] p-[2px] bg-gradient-to-br from-prakash-gold/30 via-white/10 to-red-400/30 shadow-[0_25px_60px_rgba(0,0,0,0.4)]">
                <div className="rounded-[38px] bg-black/20 backdrop-blur-2xl p-8 sm:p-12 md:p-16 border border-white/10 shadow-inner">
                  <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-white mb-4">
                    Let Vastuvid K.K. Nagaich Guide Your Yantra & Mantra Therapy
                  </h2>
                  ...
                  <Link href="/bookings" className="inline-block px-10 py-5 bg-gradient-to-r from-prakash-gold via-sacred-saffron to-red-400 text-white font-bold rounded-full shadow-[0_10px_40px_rgba(232,185,96,0.4)] hover:shadow-[0_20px_50px_rgba(255,153,51,0.5)] transition-all text-lg">
