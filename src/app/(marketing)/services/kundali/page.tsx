...
/* ------------------------------------------------------------------
   PRICING CARD – Single plan (₹5,999)
   ------------------------------------------------------------------ */
function PricingCard() {
  const whatsappMessage = `Hi VedicUrja, I want to book the Full Kundali Analysis report (₹5,999). Please share payment details.`;
  ...
  return (
    <motion.div whileHover={{ y: -8, scale: 1.03 }} className="relative max-w-md mx-auto p-8 rounded-2xl border-2 border-prakash-gold bg-white shadow-xl hover:shadow-2xl transition-all">
      ...
      <div className="text-4xl font-bold text-center mt-4 text-prakash-gold">₹5,999</div>
