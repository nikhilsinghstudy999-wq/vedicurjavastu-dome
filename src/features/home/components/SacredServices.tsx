...
const allServices = [
  { id:'residential',title:'Residential Vastu',tagline:'Homes, Flats & Quarters',desc:'Silver · Gold · Luxury plans', features:'Computerized layout audit, Remedies with/without demolition', href:'/services/residential', image:'/images/services/residential.jpg', accent:'#E8B960' },
  { id:'commercial',title:'Commercial Vastu',tagline:'Offices, Shops & Showrooms',desc:'Silver · Gold · Luxury plans', features:'Employee productivity audit, Cash counter & CEO cabin', href:'/services/commercial', image:'/images/services/commercial.jpg', accent:'#3B82F6' },
  { id:'industrial',title:'Industrial Vastu',tagline:'Factories & Manufacturing',desc:'Silver · Gold · Luxury plans', features:'Heavy machinery placement, Fire-safety & material flow', href:'/services/industrial', image:'/images/services/industrial.jpg', accent:'#6366F1' },
  { id:'land',title:'Land Selection',tagline:'Auspicious Plot Analysis',desc:'Silver · Gold · Luxury plans', features:'Kamadahana soil testing, Slope & elevation audit', href:'/services/land', image:'/images/services/land.jpg', accent:'#10B981' },
  { id:'kundali',title:'Kundali Analysis',tagline:'Vedic Nadi Jyotish',desc:'Basic · Premium plans', features:'Shadbala & Vimshottari Dasha, Gemstone & Rudraksha', href:'/services/kundali', image:'/images/services/placeholders/kundali.png', accent:'#F59E0B' },
  { id:'numerology',title:'Numerology & Namakaran',tagline:'Names + Mobile Numbers',desc:'Basic · Premium plans', features:'Newborn, Business & Adult naming, Mobile number vibration audit', href:'/services/numerology-namakaran', image:'/images/services/placeholders/numerology-namakaran.png', accent:'#2563EB' },
  { id:'virtual-consult',title:'Virtual Consult',tagline:'Global Video Session',desc:'60‑min personalised session', features:'Screen‑share floor plan, Post‑session written report', href:'/bookings', image:'/images/services/placeholders/virtual-consult.png', accent:'#0891B2' },
];
    ...
    <div className="relative w-full h-[420px] sm:h-[460px] perspective-[1200px] cursor-pointer group" onMouseEnter={()=>setFlipped(true)} onMouseLeave={()=>setFlipped(false)} onClick={()=>setFlipped(!flipped)}>
      <motion.div className="absolute inset-0 rounded-[40px] shadow-2xl" style={{transformStyle:'preserve-3d', rotateY:flipped?180:0}} transition={{duration:0.7, ease:[0.23,1,0.32,1]}}>
        ...
        <div className="absolute inset-0 rounded-[40px] bg-gradient-to-br from-white/95 via-white/80 to-white/60 backdrop-blur-xl border-2 flex flex-col" style={{backfaceVisibility:'hidden',transform:'rotateY(180deg)',borderColor:service.accent+'40'}}>
          ...
          <div className="flex-1 px-6 py-4 overflow-y-auto"><p className="text-sm text-nidra-indigo/70">{service.features}</p></div>
  ...
  return (
    <motion.section ref={ref} style={isMounted?{opacity,y}:undefined} className="py-24 md:py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {/* Kundali Full Report Card – keep as standalone */}
        <div className="mt-12 text-center">
          <div className="inline-block max-w-md w-full rounded-[40px] p-[2px] bg-gradient-to-br from-prakash-gold/40 via-sacred-saffron/30 to-kumkuma-red/30 shadow-[0_15px_40px_rgba(0,0,0,0.15)]">
            <div className="rounded-[38px] bg-gradient-to-br from-[#1A0A2E] to-[#2E0A0A] p-8 text-white">
              ...
              <p className="text-3xl font-bold text-prakash-gold mb-4">₹5,999</p>
              <a href="https://wa.me/916393570832?text=I%20want%20the%20full%20Kundali%20analysis%20report" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-prakash-gold to-sacred-saffron text-nidra-indigo font-bold rounded-full shadow-lg hover:shadow-xl transition-shadow">
