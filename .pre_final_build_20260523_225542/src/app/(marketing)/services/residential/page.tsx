...
function PainPointCard({ title, accent, points, delay }: { title: string; accent: string; points: string[]; delay?: number }) {
  const whatsappMessage = `Hi VedicUrja, I am interested in Residential Vastu consultation for: ${title.toLowerCase()}. Please guide me.`;
...
function PricingCard({ plan, price, color, features, best }: { plan: string; price: string; color: string; features: string[]; best?: boolean }) {
  const whatsappMessage = `Hi VedicUrja, I want to book the ${plan} plan (₹${price}) for Residential Vastu consultation. Please share payment details.`;
  const whatsappLink = `https://wa.me/916393570832?text=${encodeURIComponent(whatsappMessage)}`;
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          ...
          <p className="text-nidra-indigo/60 max-w-2xl mx-auto text-sm sm:text-base">
            AstroVastu Expert KK Nagaich uniquely combines Tantra mastery, MBA‑grade business acumen, and 4th‑generation Vedic lineage – a trio unmatched by any other consultant in India, especially in Uttar Pradesh.
          </p>
        </motion.div>
    ...
    <section className="py-20 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-nidra-indigo mt-3 mb-4">Your Journey to a <span className="bg-gradient-to-r from-sacred-saffron via-prakash-gold to-kumkuma-red bg-clip-text text-transparent">Harmonious Home</span></h2>
          <p className="text-nidra-indigo/60 max-w-2xl mx-auto text-sm">Simple, transparent, and personalised – from submission to transformation.</p>
        </motion.div>
      ...
      <main className="relative bg-vastu-parchment">
        ...
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1a0000] via-[#3a0a0a] to-[#0a0000]">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center mt-16">
            <span className="text-prakash-gold uppercase tracking-[0.3em] text-sm mb-4 block font-semibold">Vedic Science for Modern Living</span>
            ...
            <p className="text-sm text-white/50 max-w-2xl mx-auto mb-10">100M+ views · 80K+ followers · AstroVastu Expert KK Nagaich — Tantra‑trained, MBA, Ex‑CEO, 4th‑gen Guru, Best Vastu Expert in Uttar Pradesh.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://wa.me/916393570832?text=Hi%20VedicUrja,%20I%20want%20to%20book%20a%20Residential%20Vastu%20consultation" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-gradient-to-r from-prakash-gold via-sacred-saffron to-kumkuma-red text-white font-bold rounded-full shadow-[0_10px_30px_rgba(232,185,96,0.4)] hover:shadow-[0_20px_45px_rgba(255,153,51,0.5)] transition-all text-lg">
                Book via WhatsApp
              </a>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <PainPointCard title="New Possession (Recently Moved In)" accent="#E8B960" points={[
                ...
                <PainPointCard title="Living Here for Years (Ongoing Issues)" accent="#C88A5D" points={[
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-10">
                <PainPointCard title="Planning/Blueprint Stage" accent="#FF9933" points={[
                ...
                <PainPointCard title="Under Construction / Recently Completed" accent="#6366F1" points={[
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <PainPointCard title="Inherited / Old Family Home" accent="#8B5A2B" points={[
                ...
                <PainPointCard title="Recently Purchased / Renovated" accent="#D4A373" points={[
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <PainPointCard title="Living in Government Quarters" accent="#059669" points={[
                ...
                <PainPointCard title="Post‑Retirement / Long‑Term Quarter" accent="#047857" points={[
        ...
        <section className="py-20 bg-vastu-stone/10">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              <PricingCard plan="Silver" price="₹7/sq.ft." color="#A0A0A0" features={["No physical visit", "Computerized layout analysis", "Remedies via upto 30‑minute call", "One‑time delivery"]} />
              <PricingCard plan="Gold" price="₹10/sq.ft." color="#FFD700" features={["All Silver features", "2 follow‑up calls", "Virtual meeting included", "Extended remedy guidance"]} best />
              <PricingCard plan="Luxury" price="Custom" color="#E8B960" features={["All Gold features", "1 personal site visit", "Complete Vastu audit", "4 scheduled follow‑ups", "Full ritual execution if needed"]} />
            </div>
            <h3 className="font-serif text-xl text-sacred-saffron text-center mb-8">New Construction / Planning</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <PricingCard plan="Silver" price="₹7/sq.ft." color="#A0A0A0" features={["No physical visit", "Layout suggestions & corrections", "Remedies via upto 30‑minute call", "One‑time audit (extra audits ₹2,199 each)"]} />
              <PricingCard plan="Gold" price="₹10/sq.ft." color="#FFD700" features={["All Silver features", "2 follow‑up calls", "Virtual meeting", "2 callbacks of audit included"]} best />
        ...
        <section className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-br from-[#1a0000] via-[#3a0a0a] to-[#0a0000]">
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
              AstroVastu Expert KK Nagaich – <strong className="text-prakash-gold">100M+ views, 80K+ followers, MBA, Ex‑CEO, 4th‑generation Tantra‑trained Vastu Guru</strong> – personally performs every residential audit. No delegation. No generic reports.
            </p>
            <a href="https://wa.me/916393570832?text=Hi%20VedicUrja,%20I%20want%20to%20book%20a%20Residential%20Vastu%20consultation" target="_blank" rel="noopener noreferrer" className="inline-block px-10 py-5 bg-gradient-to-r from-prakash-gold via-sacred-saffron to-kumkuma-red text-white font-bold rounded-full shadow-[0_10px_40px_rgba(232,185,96,0.4)] hover:shadow-[0_20px_50px_rgba(255,153,51,0.5)] transition-all text-lg">
