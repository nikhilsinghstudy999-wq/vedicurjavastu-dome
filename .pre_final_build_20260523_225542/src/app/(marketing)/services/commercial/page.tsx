...
function PainPointCard({ title, accent, points, delay }: { title: string; accent: string; points: string[]; delay?: number }) {
  const whatsappMessage = `Hi VedicUrja, I am interested in Commercial Vastu consultation for: ${title.toLowerCase()}. Please guide me.`;
...
function PricingCard({ plan, price, color, features, best }: { plan: string; price: string; color: string; features: string[]; best?: boolean }) {
  const whatsappMessage = `Hi VedicUrja, I want to book the ${plan} plan (₹${price}) for Commercial Vastu consultation. Please share payment details.`;
  const whatsappLink = `https://wa.me/916393570832?text=${encodeURIComponent(whatsappMessage)}`;
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          ...
          <p className="text-nidra-indigo/60 max-w-2xl mx-auto text-sm sm:text-base">
            Vastuvid KK Nagaich uniquely combines Tantra mastery, MBA‑grade business acumen, and 4th‑generation Vedic lineage – a trio unmatched by any other commercial Vastu consultant.
          </p>
        </motion.div>
...
function YourJourneySection() {
  const steps = [
    ...
    },
    {
      ...
      desc: 'Vastuvid KK Nagaich personally analyzes your commercial space for revenue defects, employee grid, and client attraction zones.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-20 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-nidra-indigo mt-3 mb-4">Your Journey to a <span className="bg-gradient-to-r from-sacred-saffron via-prakash-gold to-kumkuma-red bg-clip-text text-transparent">Profitable Business</span></h2>
          <p className="text-nidra-indigo/60 max-w-2xl mx-auto text-sm">From layout submission to revenue growth – transparent and personalised.</p>
        </motion.div>
      ...
      <main className="relative bg-vastu-parchment">
        ...
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#1a3a5c] to-[#0a1628]">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center mt-16">
            <span className="text-prakash-gold uppercase tracking-[0.3em] text-sm mb-4 block font-semibold">Vedic Science for Business Growth</span>
            <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-white mb-6 leading-tight drop-shadow-2xl">
              <span className="bg-gradient-to-r from-prakash-gold via-sacred-saffron to-kumkuma-red bg-clip-text text-transparent">Commercial Vastu</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/70 max-w-3xl mx-auto mb-4">Offices · Shops · Showrooms · Business Growth through Vedic spatial science.</p>
            <p className="text-sm text-white/50 max-w-2xl mx-auto mb-10">MBA‑backed business perspective — every Vastu defect mapped to your P&amp;L. 100M+ views, 80K+ followers.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://wa.me/916393570832?text=Hi%20VedicUrja,%20I%20want%20to%20book%20a%20Commercial%20Vastu%20consultation" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-gradient-to-r from-prakash-gold via-sacred-saffron to-kumkuma-red text-white font-bold rounded-full shadow-[0_10px_30px_rgba(232,185,96,0.4)] hover:shadow-[0_20px_45px_rgba(255,153,51,0.5)] transition-all text-lg">
                Book via WhatsApp
              </a>
        ...
        <section id="situations" className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl text-nidra-indigo mt-3 mb-4">Identify <span className="bg-gradient-to-r from-sacred-saffron via-prakash-gold to-kumkuma-red bg-clip-text text-transparent">Your Business Challenge</span></h2>
            </div>

            {/* Offices & Corporate Spaces */}
            <div className="mb-16">
              <h3 className="font-serif text-2xl sm:text-3xl text-nidra-indigo text-center mb-8">🏢 Offices & Corporate Spaces</h3>
            ...
            {/* Shops & Retail */}
            <div>
              <h3 className="font-serif text-2xl sm:text-3xl text-nidra-indigo text-center mb-8">🛍️ Shops, Showrooms & Retail</h3>
              <div className="grid md:grid-cols-2 gap-8">
        ...
        <section className="py-20 bg-vastu-stone/10">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <PricingCard plan="Silver" price="₹7/sq.ft." color="#A0A0A0" features={["No physical visit", "Layout audit & suggestions", "Remedies via upto 30‑minute call", "One‑time delivery"]} />
              <PricingCard plan="Gold" price="₹10/sq.ft." color="#FFD700" features={["All Silver features", "2 follow‑up calls", "Virtual meeting", "Business growth strategy report"]} best />
              <PricingCard plan="Luxury" price="Custom" color="#E8B960" features={["All Gold features", "1 personal site visit", "Complete commercial audit", "4 scheduled follow‑ups", "Full ritual execution", "Employee productivity alignment"]} />
            </div>
          </div>
        </section>
        ...
        {/* FINAL CTA */}
        <section className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#1a3a5c] to-[#0a1628]">
          <div className="container mx-auto px-4 relative z-10 text-center">
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-white mb-4">Grow Your Business with Vedic Precision</h2>
            <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
              Vastuvid KK Nagaich – <strong className="text-prakash-gold">100M+ views, 80K+ followers, MBA, Ex‑CEO, 4th‑generation Tantra‑trained Vastu Guru</strong> – personally audits every commercial space. No delegation. No generic reports.
            </p>
            <a href="https://wa.me/916393570832?text=Hi%20VedicUrja,%20I%20want%20to%20book%20a%20Commercial%20Vastu%20consultation" target="_blank" rel="noopener noreferrer" className="inline-block px-10 py-5 bg-gradient-to-r from-prakash-gold via-sacred-saffron to-kumkuma-red text-white font-bold rounded-full shadow-[0_10px_40px_rgba(232,185,96,0.4)] hover:shadow-[0_20px_50px_rgba(255,153,51,0.5)] transition-all text-lg">
