    ...
    <>
        ...
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1a1a2e] via-[#2d2d44] to-[#0f0f1a] bg-[length:400%_400%] animate-[heroLoop_12s_ease_infinite]">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center mt-16">
            ...
            <p className="text-sm sm:text-base text-white/50 max-w-2xl mx-auto mb-10">9 sacred Parad (Mercury) practices — performed by AstroVastu Expert K.K. Nagaich, 4th generation Guru, MBA, Ex‑CEO. Parad, revered as the seed of Lord Shiva, is the most potent and auspicious metal in Vedic spiritual science.</p>
            ...
            <div className="max-w-3xl mx-auto text-center">
              <div className="relative rounded-[40px] p-[2px] bg-gradient-to-br from-silver-400/30 via-white/10 to-prakash-gold/30 shadow-[0_25px_60px_rgba(0,0,0,0.4)]">
                <div className="rounded-[38px] bg-black/20 backdrop-blur-2xl p-8 sm:p-12 md:p-16 border border-white/10 shadow-inner">
                  ...
                  <p className="text-white/70 text-base sm:text-lg max-w-xl mx-auto mb-10">Book a consultation with AstroVastu Expert K.K. Nagaich for a personalised Parad prescription and sacred installation — performed personally by a 4th‑generation Vastu Guru with 20+ years of clinical practice and 2 Lakh+ clients worldwide.</p>
