    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-gradient-to-br from-[#0a001a] via-[#1a0030] to-[#0a001a] backdrop-blur-sm"
        >
          {/* SVG Loader */}
          <svg
            className="pl w-32 h-32 sm:w-40 sm:h-40"
            viewBox="0 0 160 160"
            width="160"
            height="160"
          ...
          {/* Typewriter text */}
          <div className="mt-8 text-prakash-gold font-serif text-xl sm:text-2xl tracking-wide">
            {displayText}
            <span className="animate-pulse">|</span>
          </div>

          {/* Inline keyframes (only for the tick animations) */}
          <style>{`
            .pl {
              display: block;
              width: 9.375em;
