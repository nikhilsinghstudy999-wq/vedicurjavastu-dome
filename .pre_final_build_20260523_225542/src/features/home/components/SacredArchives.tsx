...
export default function SacredArchives() {
  ...
  return (
    <motion.section ref={ref} style={isMounted ? { y } : undefined} className="py-24 bg-gradient-to-b from-white to-vastu-parchment">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="font-serif text-3xl sm:text-4xl text-nidra-indigo">From the Sacred Archives</h2>
            <p className="text-nidra-indigo/60 mt-2">Wisdom from the Vedic tradition</p>
          </div>
          <Link href="/insights" className="text-prakash-gold hover:underline font-medium">View all →</Link>
        </div>
