...
echo -e "${GREEN}FIX: CLEAN FULL‑WIDTH HEADER, NO ROUNDED EDGES, CORRECT HEIGHT, NO WHITE GAP${NC}"

cat > src/features/shared/components/Header.tsx << 'ENDHEADER'
'use client';
...
echo ""
echo -e "${GREEN}✅ HEADER: Full‑width, no rounded edges, correct height spacer, no white gap${NC}"
echo "   • Flat bottom with 2px animated gradient line"
echo "   • Looping purple/red/cyan/orange background"
echo "   • Exact height 60px (56px mobile), matching spacer"
echo "   • Mobile menu with same gradient"